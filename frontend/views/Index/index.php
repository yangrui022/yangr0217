...
<div class="floor1 floor w1210 bc mt10">
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="brand">
            ...
            <div class="sidebar_wrap">
                <ul>
                    <li><a href=""></a><?=Html::img('@web/images/dell.gif')?></li>
                    <li><a href=""></a><?=Html::img('@web/images/acer.gif')?></li>
                    <li><a href=""><?=Html::img('@web/images/fujitsu.jpg')?></a></li>
                    <li><a href=""></a><?=Html::img('@web/images/hp.jpg')?></li>
                    <li><a href=""><?=Html::img('@web/images/lenove.jpg')?></a></li>
                    <li><a href=""><?=Html::img('@web/images/samsung.jpg')?></a></li>
