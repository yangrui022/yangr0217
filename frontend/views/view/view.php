    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <?=\yii\helpers\Html::img('http://admin.yii2shop.com'.$good->logo,['class'=>'jqzoom','rel'=>'gal1'])?><a href="images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
