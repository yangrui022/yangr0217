        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    ...
                    <a href="http://admin.yii2shop.com<?=$good->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                       <?=\yii\helpers\Html::img('http://admin.yii2shop.com'.$good->logo,['width'=>350,'height'=>350])?>               <!-- 第一幅图片的中图 -->
                    </a>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            ?>
                            <li <?=$k==0?'class="cur"':''?>>
                                <a <?=$k==0?'class="zoomThumbActive':''?>href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?='http://admin.yii2shop.com'.$img->goods_photos?>',largeimage: '<?='http://admin.yii2shop.com'.$img->goods_photos?>'}"><?=\yii\helpers\Html::img('http://admin.yii2shop.com'.$img->goods_photos)?></a>
                            </li>
                            <?php endforeach;?>
